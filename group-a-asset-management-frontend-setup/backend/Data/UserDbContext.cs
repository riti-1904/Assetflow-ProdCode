...
namespace AssetFlow.Auth.Data
{
    public class UserDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure Fault table and relationships
            ...
            modelBuilder.Entity<Fault>()
                ...
                .HasConstraintName("FK_Faults_Assets")
            ...
            modelBuilder.Entity<Fault>()
                ...
                .HasConstraintName("FK_Faults_ReportedByUser")
                .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Fault>()
                ...
                .HasConstraintName("FK_Faults_AssignedToUser")
                .OnDelete(DeleteBehavior.Restrict);
        }
    }
}
...
//             // Fault -> Reporter (User) relationship
//             modelBuilder.Entity<Fault>()
//                 .HasOne(f => f.Reporter)
//                 .WithMany()
//                 .HasForeignKey(f => f.ReportedByUserId)
...
//             // Fault -> Technician (User) relationship
//             modelBuilder.Entity<Fault>()
//                 .HasOne(f => f.Technician)
//                 .WithMany()
//                 .HasForeignKey(f => f.AssignedToUserId)
